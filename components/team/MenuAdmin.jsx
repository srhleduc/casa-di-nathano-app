  ...
  if (!canEdit) {
    return (
      <div className="flex-1 overflow-y-auto px-6 py-4">
        <div className="rounded-2xl border border-[#3a2b1f] bg-[#211712] p-4 mb-6 text-sm text-[#a88f78]">
          ℹ️ Le menu est désormais géré depuis l'espace Direction. Cette page est en lecture seule.
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {items.map((item) => (
            <div key={item.id} className="rounded-xl border border-[#3a2b1f] bg-[#211712] p-4">
