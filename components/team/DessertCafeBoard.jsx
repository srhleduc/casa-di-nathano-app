...
export default function DessertCafeBoard() {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 py-4">
      <p className="text-[#a88f78] mb-4 text-sm">Desserts, cafés et thés à préparer — indépendamment de l'avancée du four.</p>
      {withItems.length === 0 && <p className="text-[#8a7561]">Rien à préparer pour l'instant.</p>}
