...
// partir d'une liste de pointage_entries (voir lib/data.js). Une journée qui
// se termine sans "depart" (pointage manquant, ou export lancé en cours de
// service) ne compte que jusqu'au dernier pointage connu — pas d'heure
// devinée. Renvoie une Map "staffId|YYYY-MM-DD" -> minutes.
export function computeDailyWorkedMinutes(entries) {
