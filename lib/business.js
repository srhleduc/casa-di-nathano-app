...
// File du four : les commandes à emporter d'abord (par créneau, comme
// d'habitude), puis le sur place / sur place déjà réservé en dessous, dans
// l'ordre où elles ont été envoyées (elles n'ont généralement pas de
// créneau propre, donc les trier par heure de créneau les mélangeait au
// hasard tout en bas de la file).
export function sortKitchenQueue(list) {
  return [...list].sort((a, b) => {
    ...
    if (aTakeaway) return orderSortMinutes(a) - orderSortMinutes(b);
