...
export function serviceTypeBadgeStyle(serviceType) {
  if (serviceType === IMMEDIATE_TAKEAWAY_SERVICE_TYPE) return { background: "var(--color-service-immediate-bg)", color: "var(--color-service-immediate-text)" };
  if (serviceType === RESERVED_SERVICE_TYPE) return { background: "var(--color-success-bg)", color: "var(--color-success)" };
  if (serviceType === "🍽️ Sur place") return { background: "var(--color-service-dine-in-bg)", color: "var(--color-service-dine-in-text)" };
  return { background: "var(--color-service-other-bg)", color: "var(--color-service-other-text)" };
}
