...
// on écarte les créneaux trop proches (< nowMin + délai mini). Le délai mini
// vient de `settings.bookingLeadMinutes` (réglable, défaut 30) ; `leadMin` en
// option ne sert qu'aux tests.
