...
//
// `occupiedWithoutReservationCovers` (option, service en cours uniquement) :
// couverts de tables actuellement occupées par une commande SANS réservation
// qui les tienne (clients de passage — /sat, ou avant qu'une réservation
// « Passage » ne soit posée). Ils ne comptent dans aucune réservation mais
// consomment bien de la capacité : `remaining`/`full` les prennent en
// compte, en plus de `reserved`, et sont renvoyés à part dans `occupied`
// pour que l'équipe voie la différence entre réservé et occupé.
export function serviceSynthesis(reservationsForService, service, unassignedCount = 0, occupiedWithoutReservationCovers = 0) {
