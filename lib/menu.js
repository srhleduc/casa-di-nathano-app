...
export const DESSERT_STOCK_GROUPS = [
  { key: "pannacotta", label: "Panna Cotta (à emporter)", itemNames: ["Pana Cotta Framboise", "Pana Cotta Mangue"], scope: "takeaway" },
  { key: "pannacotta_sur_place", label: "Panna Cotta (sur place)", itemNames: ["Pana Cotta Framboise", "Pana Cotta Mangue"], scope: "dineIn" },
  { key: "tiramisu_cafe", label: "Tiramisu Café (à emporter)", itemNames: ["Tiramisu Café"], scope: "takeaway" },
  { key: "tiramisu_cafe_sur_place", label: "Tiramisu Café (sur place)", itemNames: ["Tiramisu Café"], scope: "dineIn" },
  { key: "tiramisu_speculoos", label: "Tiramisu Spéculoos (à emporter)", itemNames: ["Tiramisu Spéculoos"], scope: "takeaway" },
  { key: "tiramisu_speculoos_sur_place", label: "Tiramisu Spéculoos (sur place)", itemNames: ["Tiramisu Spéculoos"], scope: "dineIn" },
