...
export async function insertIngredient({ name, unit, costPerUnit, purchaseQty, purchaseUnit, purchasePrice }) {
...
export async function updateIngredient(id, { name, unit, costPerUnit, purchaseQty, purchaseUnit, purchasePrice }) {
  const row = {};
  if (name !== undefined) row.name = name;
