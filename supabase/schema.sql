...
-- dans la colonne nom (souvent "Prénom NOM"). Enregistre chaque tentative et
-- refuse au-delà de 12 tentatives / IP / 10 min (status 'rate_limited').
-- status : 'ok' | 'not_found' | 'rate_limited'. 'not_found' couvre aussi
-- bien "téléphone inconnu" que "nom incorrect" (aucun indice).
